...
Product.ConfigurableSwatches.prototype = {
    ...
    attachOptEvents: function(opt) {
        ...
        // Swatch Events
        if (opt._f.isSwatch) {
            if (opt._e.a.href != 'javascript:void(0)') {
                return false;
            }
            //
    ...
    onSelectChange: function(select)
    {
        ...
        if (this._F.nativeSelectChange) {
            ...
            if (option.opt) {
                ...
                if (attr._e._last.selectedOption)
                ...
                if (pos !== -1)
                    this._E.activeConfigurableOptions.splice(pos, 1);
    ...
    updateSelect: function(attr) {
        ...
        if (attr._e.selectedOption !== false && attr._e.optionSelect) {
            ...
            // bainguyen
            //
            //default : ConfigurableMediaImages.updateImage(attr._e.optionSelect);
            //attr.id = 134 (if attr is size => dont change image)
            //
            if (attr.id != '134') {
