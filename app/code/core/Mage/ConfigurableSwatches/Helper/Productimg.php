...
//            $swatchType = 'product';
            $url = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA).'catalog/product'. $filename;
//            $filename = $image->getFile();
//            $swatchImage = $this->_resizeSwatchImage($filename, 'product', $width, $height);
//            $swatchType = 'product';
//            $url = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA).'catalog/product'. $swatchImage;
        }
