...
//            }
    ...
    public function getHomeusers($withPrefix = true)
    {
        $rawUsers = Mage::getStoreConfig('ikantam_instagramconnect/module_options/homeusers');
        $users = explode(',', $rawUsers);
    ...
    public function getEndpointUrl($userId)
    {
        ...
        $helper = Mage::helper('instagramconnect');
        $accessToken = Mage::getModel('instagramconnect/instagramauth')->getAccessToken();
        $count = (int)Mage::getStoreConfig('ikantam_instagramconnect/module_options/max_photo_count');
        if(!$count):
            $count = 20;
        endif;
