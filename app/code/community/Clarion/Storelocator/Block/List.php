...
//            search by state
            ...
            if($radius){
                $this->_storesCollection->addFieldToFilter('radius', array('lteq'=>$radius));
            }
        }
//        $this->_storesCollection->load(); // some times you need to call load() to be sure your collection don't get changes later in some place
//echo $this->_storesCollection->getSelect(); // to print query
